<?php
    include 'header.php';
     ...
     $search = $_GET['search'];
     $sqlCat = "SELECT * FROM productos WHERE nombreProducto LIKE '%".$search."%'";
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-9 col-sm-push-3">
							<h1 class="size-17 margin-bottom-20">PRODUCTOS ENCONTRADOS</h1>
						...
						<div class="col-sm-3 col-sm-pull-9">
							...
							<div class="margin-bottom-60">
								...
								<a href="garantia.php">Politica de Garantía &raquo;</a>
							</div>
							<!-- /FREE RETURNS -->
...
<section>
	...
	<div class="owl-carousel nomargin" data-plugin-options='{"singleItem": false, "autoPlay": true}'>
		<?php do{?>  
            <div>
                <img class="img-responsive" src="Administrador/assets/uploads/slider/<?php echo $Marcas['imagen']; ?>" alt="">
            </div>
		<?php }while($Marcas = mysql_fetch_assoc($queryMarcas)) ?>
	</div>
</div>
